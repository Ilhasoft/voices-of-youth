...
import voicesofyouth.users.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', django_resized.forms.ResizedImageField(blank=True, crop=['middle', 'center'], keep_meta=True, null=True, quality=0, size=[50, 50], upload_to=voicesofyouth.users.models.upload_to, verbose_name='Image')),
